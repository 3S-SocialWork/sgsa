 ...
 * Original source: https://github.com/synaptic-cl/ra-data-drf/blob/develop/src/index.js
 */
const DjangoRestProvider = (apiUrl, httpClient = fetchUtils.fetchJson) => {
	/**
...
export default DjangoRestProvider;
